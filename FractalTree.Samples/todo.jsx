            ...
            "flex-1 w-full">
                ...
                "h-full bg-white">
                    ...
                    "w-full h-full">
                        <div 
                        className=
                        "divide-y divide-pink-200">
                            <div 
                            className=
                            
                            "p-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <h1 
                                className=
                                "text-3xl font-bold text-center mb-8 text-pink-600">Todo List</h1>
                                ...
                                className="flex gap-2 mb-6">
                                    <input
                                        ...
                                        className=
                                        "flex-1 px-4 py-2 border focus:outline-none focus:border-pink-600"
